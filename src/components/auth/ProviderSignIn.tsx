...
const ProviderSignIn = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-900 via-teal-800 to-teal-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <button
          onClick={() => navigate('/')}
          className="flex items-center text-teal-100 hover:text-white mb-8 transition-colors"
        >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center text-sm">
              <span className="text-gray-600 dark:text-gray-400">Not a provider yet? </span>
              <button 
                type="button"
