...
import { Wrench, Calendar, MapPin, Clock, ListChecks } from 'lucide-react';
...
const HandymanBooking = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!bookingData.location || !bookingData.serviceType) {
      return;
    }
    navigate('/book/handyman/matches', { state: { requirements: bookingData } });
  };
